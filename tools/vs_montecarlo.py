...
WAD = "doom.wad"
SAMPLES = 600
DD = 1000          # draw-distance horizon (the author's smooth preset dd=1000)
...
# the author's ground truth: some maps chug, most are smooth. Flag the top ~quartile as CHUG risk.
